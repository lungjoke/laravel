            ...
            <table class="table table-striped projects">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @else
                        <img  src="{{asset('assets/images/products')}}/{{$product->product_image}}"class="rounded"width="50"height="50">
                        @endif
                        </td>
                        <td>
                            <a>
                        ...
                        <td><span >{!! (config('global.pro_status')[$product->product_status])!!}</span></td>
