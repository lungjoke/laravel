                 ...
                 <div class="row">
                     <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  {{ $errors->has('product_barcode') ? 'is-invalid' :'' }}" id="product_barcode" name="product_barcode" placeholder="ป้อนบาร์โค้ด" value="{{$product->product_barcode}}">
